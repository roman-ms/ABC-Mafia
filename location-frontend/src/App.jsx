    ...
    <>
      ...
      <footer className="mt-8 bg-blue-600 px-4 py-8 text-white lg:p-8">
        <div className="container mx-auto max-w-4xl">
          ...
          <p>
            Care Cubby is a supply-based mutual aid system where each location
            is categorized by a letter, and you can pick/supplies based on the
            letter category for free. The ultimate goal of this project is to
            create a centralized hub for people to find /trade the goods they
            need to survive and thrive, and connect people to community centers
            and local orgs/businesses they may not know about otherwise. This
            project is run primarily by queer run grassroots orgs who are driven
            to create a kinder and more supportive world through the work they
            do. You can support this project by spreading the word, donating, or
            submitting to be a cubby location!
          </p>
        </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute -left-6 flex h-24 w-24 items-center justify-center overflow-hidden rounded-full bg-blue-500 shadow-lg">
                    <img
                      src={`./${label}.PNG`} // images must be in public folder
                      alt={`Logo ${label}`}
